...
**From an award-winning mathematical modeling challenge to a reproducible
...
<table>
  <tr>
    <td width="50%" align="center">
      <a href="remodeled-model/results/baseline/temperature.png">
        <img src="remodeled-model/results/baseline/temperature.png"
             alt="Baseline air and structural temperature over time"
             width="100%">
      </a>
      <br>
      <sub><b>Baseline temperature:</b> air and effective structural response.</sub>
    </td>
    <td width="50%" align="center">
      <a href="remodeled-model/results/baseline/co2.png">
        <img src="remodeled-model/results/baseline/co2.png"
             alt="Baseline carbon-dioxide concentration over time"
             width="100%">
      </a>
      <br>
      <sub><b>Baseline CO₂:</b> ventilation-related concentration state.</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <a href="remodeled-model/results/scenarios/scenario_temperature.png">
        <img src="remodeled-model/results/scenarios/scenario_temperature.png"
             alt="Air-temperature comparison across Version 2 scenarios"
             width="100%">
      </a>
      <br>
      <sub><b>Scenario comparison:</b> modeled air temperature across cases.</sub>
    </td>
    <td width="50%" align="center">
      <a href="remodeled-model/results/optimization/energy_vs_maximum_temperature.png">
        <img src="remodeled-model/results/optimization/energy_vs_maximum_temperature.png"
             alt="Fan-energy proxy versus maximum modeled air temperature"
             width="100%">
      </a>
      <br>
      <sub><b>Optimization experiment:</b> fan-energy proxy and maximum temperature.</sub>
    </td>
  </tr>
</table>
